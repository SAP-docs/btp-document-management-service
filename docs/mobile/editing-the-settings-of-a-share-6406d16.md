<!-- loio6406d16615174d5a9376ea811e868adf -->

# Editing the Settings of a Share

You can edit the settings of a share starting in the desktop application, which then opens the Web application.



## Prerequisites

-   You are the owner or an administrator of this share.
...
2.  Navigate to the *Collaboration Repository*.

3.  Choose one of the following options:

    -   Right-click the share for which you want to change settings.

    -   Open the share, and right-click anywhere in the folder either empty space or any files and folders.
