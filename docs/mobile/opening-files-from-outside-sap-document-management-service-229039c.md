<!-- loio229039c705f04fb28ed8876725e5fed3 -->

# Opening Files from Outside SAP Document Management Service

On iOS devices, you can access files that are stored in SAP Document Management Service from other applications that support Apple's Document Provider extension.



## Prerequisites

-   Your administrator has adjusted the settings of SAP Document Management Service passcodes for document providers.
...
1.  To open a file within an external app using the SAP Document Management Service extension, look for the app extension \(for example, in Microsoft Office 365 Word under *Open* \> *More* there is a list of available application extensions\).

2.  Depending on the external app, you can also save your files back to SAP Document Management Service.
