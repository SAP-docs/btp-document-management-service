<!-- loio0943d868457d4cafb38ea4bac4a093bd -->

# Using Stored Web Links

You can open stored Web links on your iOS device.



## Prerequisites

-   You've created a Web link, for example, by dragging it to your PC desktop.

-   You've stored the Web link in the *Repository*, for example, by dragging it there using the file explorer.
...
1.  Open *Repository* on your iOS device.
