<!-- loiofb506967d58f4a4da5774b5ff637aac9 -->

# Editing Files From External Editors

On Android devices, you can access files that are stored in SAP Document Management Service from other applications that support the Document Provider extension. You can edit these files and then save them back to SAP Document Management Service.
...
-   You have not set a passcode for SAP Document Management Service.
-   Your external app supports the Document Provider extension.



<a name="loiofb506967d58f4a4da5774b5ff637aac9__steps_zyd_lfj_lt"/>

## Procedure

1.  To open a file within an external app using the SAP Document Management Service extension, look for the app extension.

    In Microsoft Office 365 Word, for example, choose *Open* \> *More*. There is a list of available application extensions.

2.  Edit your file.

3.  Save your file back to SAP Document Management Service.

    1.  In the external app, open or select the file and then choose the option to store the file, for example, *Export* or *Save*.

    2.  From the list of available storage locations, choose the SAP Document Management Service app extension.
