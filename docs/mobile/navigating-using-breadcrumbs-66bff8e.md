<!-- loio66bff8ebc0d24fedb4c3bc1b5e804526 -->

# Navigating Using Breadcrumbs

In the SAP Document Management Service iOS client you can switch easily to parent folders of the current folder.



## Context

You can either use a short tap to move one folder level up or you can use a long tap to display a list of parent folders that you can navigate to.



## Procedure

1.  To return to any higher-level folder of the folder you are currently in, long-tap the breadcrumb link.

    The breadcrumb link is situated in the title bar of the folder's documents list, to the left of the folder title, for example, *< Sync Documents*.
