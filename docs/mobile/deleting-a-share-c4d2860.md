<!-- loioc4d2860fc13d4e6695557d3344aee169 -->

# Deleting a Share

You can delete a share directly in the desktop app.



<a name="loioc4d2860fc13d4e6695557d3344aee169__steps_e12_trs_2y"/>

## Procedure

1.  In the desktop app, open the *Repositories* folder.

2.  Right-click the share you want to delete.

3.  From the context menu, choose *Document Management Service* \> *Delete Share*.
