<!-- loio2fba81d08f5846f18a9f439a354c8247 -->

# Requesting Support

You can create an incident to the team responsible for advice on the desktop app.



## Prerequisites

-   Your administrator has enabled logging.

-   For downloading logs, you've to activate logging. In the tray context menu, choose *Settings* \> *Enable Logging*, and then *Save*.
...
1.  Right-click the tray icon \(![](images/SDM_Client_Service_Desktop_Icon_b0aa4d2.png)\).

2.  Choose *Help* \> *Request Support*.

3.  Raise an incident under the support component [BC-CP-CF-SDM-APP\] and attach the `Log.zip` file. A log file can be found on the path for windows users `C:\Users\ABC\AppData\Local\Document Management`. For Mac users, the path is `Users/ABC/Library/Preferences/logs/Document Management`.
