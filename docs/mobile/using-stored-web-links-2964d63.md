<!-- loio2964d6390e73478b93f0fc2690f8bc5c -->

# Using Stored Web Links

You can open stored Web links on your Android device.



## Prerequisites

-   You are using Microsoft Windows on your PC.

-   You have created a Web link, for example, by dragging it to your PC desktop.

-   You have stored the Web link in the repository, for example, by dragging it there using the file explorer.
...
1.  Open *Repository* on your Android device.

2.  Tap the respective ![](images/Android_Icon_Web_Link_34961cb.png) \(link file\).

3.  In the security dialog, confirm that you want to open the respective URL.
