<!-- loio3d28fed7928c4060be399fd796fcbe6e -->

# Copying the Link to a File or Folder

You can copy the link to any file or folder of your Document Management Service desktop app to the clipboard of your device.



<a name="loio3d28fed7928c4060be399fd796fcbe6e__prereq_jwc_xdg_1z"/>

## Prerequisites

Your file or folder is in one of the following repositories:
...
<a name="loio3d28fed7928c4060be399fd796fcbe6e__steps_inx_b2g_1z"/>

## Procedure

1.  Open the *Document Management* folder in your Explorer \(Windows\) or in Finder \(Mac\).

2.  Select the file or folder for which you want to copy the Web link.

3.  Choose *Copy Web Link*.




<a name="loio3d28fed7928c4060be399fd796fcbe6e__result_gcd_g2g_1z"/>

## Results

The Web link is copied to the clipboard and you can insert it, for example, in mails. A notification is displayed above the tray icon \(![Tray Icon](images/Tray_Icon_7362ba2.png)![](images/SDC_Tray_Icon_Basic_5cd778a.png)\).
