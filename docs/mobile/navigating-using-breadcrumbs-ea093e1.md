<!-- loioea093e10336c41d889a6c218c8137c36 -->

# Navigating Using Breadcrumbs

In the SAP Document Management Service android app, you can switch easily to parent folders of the current folder.



## Context

You can tap on name of file and folder in title bar to display a list of parent folders that you can navigate to.



## Procedure

1.  To return to any higher-level folder of the folder you are currently in, tap on the file name and folder in the title bar.

2.  In the list of higher-level folders that appear, choose the folder you want to switch to.




<a name="loioea093e10336c41d889a6c218c8137c36__result_brt_hxl_cbb"/>

## Results

You can navigate to the selected folder.
