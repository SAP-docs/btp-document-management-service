<!-- loio452f0e12e00a4921bb342503111b6e41 -->

# Sharing Files or Folders

You can share files or folders using the context menu of *Document Management Service*.
...
You can either move the files or folders to your new share or you can just put a copy of them into your new share.



## Procedure

1.  Select one or more files and folders that you want to share.

2.  Right-click to open the context menu.

3.  Optional: You can change the proposed name of the share.

4.  Decide who should be able to access the share: *Anyone with a link has access* or named members, which you add using the Web UI.

    For more information on adding share members, see [Creating New Empty Share](creating-new-empty-share-63606a2.md) .

5.  Optional: Change the number of days for which other users can access this link.

6.  Optional: To delete the share permanently after the public link has expired, select *Delete share permanently after expiration*, and then select the period of grace before deletion from the dropdown list.

    > ### Caution:  
    > The share is deleted permanently and can't be recovered.

7.  Optional: To protect the link with a password, select *Password Protection*.

8.  Choose *Create*.

    You receive a confirmation message stating that your share was created. The screen offers the following options:

    -   E-Mail Link

        Opens the default mail client and adds the link to the share in the text body of the mail.

    -   Copy Link

        Copies the link to your newly created share in the desktop app.

    -   Close

        Closes the screen without further action.
...
Your share was created under *Repositories* and contains the selected files and folders.

You're the owner of the share. Your name is displayed in the following format: ***<first name\>.<last name\>@<email\_domain\>***. For example, ***Jhon.Doe@sap.com***.
