<!-- loioab3b9b82de2c409993a04a0376de8d6d -->

# Creating Files

To synchronize files using the Document Management Service desktop app, store these files in your root folder.



## Procedure

1.  Create your files in the usual way on your PC or laptop.

2.  Store the files in your *Document Management* folder.

    -   On Microsoft Windows, the default location of this folder is <code>C:\\Users\<i class="varname">&lt;user&gt;</i>\Document Management</code>.
    -   On Mac OS, the default location of this folder is <code>/Users/<i class="varname">&lt;user&gt;</i>/Document Management</code>.

    The *Document Management* folder is also displayed under *Quick Access* in Microsoft Windows Explorer. You can also open the folder by double-clicking the Document Management Service tray icon \(![](images/SDM_Client_Service_Desktop_Icon_b0aa4d2.png)\).

    You can change the location of the Document Management Service folder \(also called the root folder\) in the *Settings* window as described in[Configuring SAP Document Management Service for Desktop Client](configuring-sap-document-management-service-for-desktop-client-585d79d.md) .
...
The Document Management Service desktop app automatically synchronizes your local files with the Document Management Service server.
