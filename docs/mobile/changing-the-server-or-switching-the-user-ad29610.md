<!-- loioad29610c2bda4fa3819f7797297834b3 -->

# Changing the Server or Switching the User

You either use oAuth or user name and password plus the *Remember Password* setting to log on to your desktop app. To use a different logon mode or to log on with another oAuth user, you unlink your account.
...
<a name="loioad29610c2bda4fa3819f7797297834b3__steps_rpj_sz4_pw"/>
...
2.  On the *Account* tab, choose *Unlink Account*.

3.  On the confirmation popup, choose *Yes*.
...
You are logged off and are forwarded to the logon page. There you can enter a different server URL and choose one of the log on methods available.
