<!-- loiod2e3a48d02ca45f0bf13b2bc62e133b2 -->

# Checking the App Connection Status \(iPad\)

On the iPad, the connection status of the SAP Document Management Service app is displayed for quick reference.

The iPad displays the following status:

-   ![](images/iOS_Icon_Status_Connected_f5f9967.jpg): The SAP Document Management Service app is connected to the SAP Document Management Service server. This also indicates that Wi-Fi is available.
-   ![](images/iOS_Icon_Status_Disconnected_694d7fb.jpg): The SAP Document Management Service app is not connected to the SAP Document Management Service server. Check whether Wi-Fi is off.
-   ![](images/iOS_Icon_Status_Sync_4cc969e.jpg): At least one file has been marked for offline access and the SAP Document Management Service app has started synchronizing.
-   ![](images/iOS_Icon_Status_Error_86eb190.jpg): The SAP Document Management Service app could not make at least one file available for offline access.
