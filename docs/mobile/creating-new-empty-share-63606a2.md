<!-- loio63606a26ffb84f8abe7b631142f2ea2f -->

# Creating New Empty Share

You can create a new share directly in the desktop app.



<a name="loio63606a26ffb84f8abe7b631142f2ea2f__steps_e12_trs_2y"/>

## Procedure

1.  In the desktop app, open the *Repositories* folder.

2.  Navigate inside the *Collaboration Repository*.

3.  Right-click anywhere in the empty space.

4.  From the context menu, choose *Document Management Service* \> *Create Share*.

5.  Enter a name for your share and fill in the other options as needed.

6.  On the confirmation screen for the share creation you've the following options:
