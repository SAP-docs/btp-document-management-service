<!-- loio8c5a10c77fd34b289e8947da1b5464a8 -->
...
<a name="loio8c5a10c77fd34b289e8947da1b5464a8__prereq_rjj_trs_zy"/>
...
<a name="loio8c5a10c77fd34b289e8947da1b5464a8__context_mn3_tts_zy"/>

## Context

On your iOS device, you can also access favorites, which you have created in the Web app.



<a name="loio8c5a10c77fd34b289e8947da1b5464a8__steps_ezf_srs_zy"/>

## Procedure

The following actions are available for favorites:

-   To add one or more files and/or folders, select them and choose *Send* \> *Add to Favorites*.

-   To access a favorite, tap it. Folders will display the documents list, files will open directly.

-   To remove a file or folder from the *Favorites*, select the respective file or folder and choose *Delete*. Confirm the deletion.

-   To refresh the favorites list, pull down the documents list.
