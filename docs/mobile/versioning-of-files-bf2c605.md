<!-- loiobf2c6057c93f4903be38ecf86c369b7b -->

# Versioning of Files

The SAP Document Management Service iOS app enables you to work with versioned documents, but hides advanced actions such as check out and check in.

When you modify versioned documents from the iOS app, new versions are created automatically.
