<!-- loiofa5bc9d3e4f54f75a2d2120037fb3ae8 -->

# Renaming a Share

You can rename a share using the Document Management Service context menu in your Explorer \(Windows\) or in Finder \(Mac\)..



<a name="loiofa5bc9d3e4f54f75a2d2120037fb3ae8__prereq_bbp_vxg_yz"/>

## Prerequisites

-   You're the owner or an administrator of this share.

-   The share is selected for automatic sync.
...
<a name="loiofa5bc9d3e4f54f75a2d2120037fb3ae8__steps_cbp_vxg_yz"/>

## Procedure

1.  In the desktop app, open the *Repositories* folder.

2.  Right-click the share, which you want to rename.

3.  From the context menu, choose *Document Management Service* \> *Rename Share*.
